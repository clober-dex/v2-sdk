...
export const CONTRACT_ADDRESSES: {
  ...
  [CHAIN_IDS.ARBITRUM_SEPOLIA]: {
    ...
    Rebalancer: getAddress('0xCd92C120762Afd1ef6f50D656615203900438CDE'),
    Strategy: getAddress('0x361F24114F1DD6AEC9376CAE4185383A9b876E20'),
    Minter: getAddress('0x314eA40Dc31568cEA80F684D6e6f9E1fd7dD0a8e'),
    Operator: getAddress('0x5e8536EF7CCfdB2499a9CAD2fbEB9f9FDC0E8d05'),
  },
  [CHAIN_IDS.BASE]: {

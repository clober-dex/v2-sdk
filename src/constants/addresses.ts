...
export const CONTRACT_ADDRESSES: {
  ...
  [CHAIN_IDS.ARBITRUM_SEPOLIA]: {
    Controller: getAddress('0x747b1D740B51f458568A24448162F51B933aa68d'),
  ...
  [CHAIN_IDS.BASE]: {
    Controller: getAddress('0xeC7385C35dD8038AcfFf89595106e20930b8678C'),
  ...
  [CHAIN_IDS.BERACHAIN_TESTNET]: {
    Controller: getAddress('0x7588AFc469d95300C2206Bf8a6Ee9bf5d2719314'),

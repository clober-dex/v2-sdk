...
export const CONTRACT_ADDRESSES: {
  ...
  [CHAIN_IDS.BASE]: {
    ...
    Rebalancer: getAddress('0x13f2Ff6Cc952f4181D6c316426e9CbdA957c6482'),
    Strategy: getAddress('0x284A7A4c8Bc2873EDCa149809C1CAaaf3C4ED6eb'),
    Minter: getAddress('0xA633bd3a76957d390525103CB60c98518f586389'),
    Operator: getAddress('0xC7F4EC7556dbe1d5e64308D0e384B30716D631e3'),
  },
